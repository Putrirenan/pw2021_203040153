...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2021 at 01:33 PM
...
('root', '[{\"db\":\"pw_tubes_203040153\",\"table\":\"products\"}]');
...
('root', 'pw_tubes_203040153', 'products', '{\"sorted_col\":\"`products`.`id` ASC\"}', '2021-03-20 14:41:57');
...
('root', '2021-03-24 12:31:13', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `pw_tubes_203040153` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pw_tubes_203040153`;
