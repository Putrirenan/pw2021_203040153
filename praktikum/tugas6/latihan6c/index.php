...
<body>
    ...
    <a href="php/login.php" class="login" style="text-decoration:none;"> 
        <button type="submit" class="login link-dark btn btn-danger text-white">Masuk ke halaman admin</button>
    </a>
