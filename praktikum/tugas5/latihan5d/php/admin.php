        ...
        <table class="table table-hover table-sm table-responsive table align-middle">
            ...
            <?php foreach ($products as $p) : ?>
                    <tr>
                        <td><?= $i; ?></td>
                        <td>
                        <a href="ubah.php?id=<?= $p['id']; ?>" class="link-dark btn btn-warning btn-sm" style="text-decoration:none;">Ubah</a>
                        <a href="hapus.php?id=<?= $p['id']; ?>" onclick="return confirm('Hapus Data??')" class="link-dark btn btn-warning btn-sm" style="text-decoration:none;">Hapus</a>
                        </td>
